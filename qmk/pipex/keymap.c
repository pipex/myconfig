 ...
 * |      |      |      |      |      |      |      |      |      |      |      |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  >=  |  <<  |  >>  |      |      |             |      | Mute |VolDn |VolUp |Print |
 * `-----------------------------------------------------------------------------------'
 * 
 */
[_LOWER] = LAYOUT_planck_grid(
    KC_GRV ,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_BSPC,
    _______, _______, _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR,  KC_ENT,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_RSFT,
       LOCK,   PRINT, _______, _______, _______, _______, _______, _______, KC_HOME, KC_PGDN, KC_PGUP,  KC_END 
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______,  _______, KC__VOLDOWN, KC__VOLUP, KC__MUTE
),
/* Numpad
 * ,-----------------------------------------------------------------------------------.
 * |      |      |      |      |      |      |      |   7  |   8  |   9  |   /  | BKsp |
...
[_NUMPAD] = LAYOUT_planck_grid(
    ...
    _______, _______, _______, _______, _______, _______, _______, KC_KP_0, KC_COMM, KC_PDOT, KC_PPLS, _______
),
