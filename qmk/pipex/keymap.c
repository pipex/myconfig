...
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_QUOTE,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,  KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, KC_MPRV, KC_MNXT, KC_BRID, KC_BRIU,
    KC_SLEP, _______, _______, _______, _______, _______, _______, _______, KC_BSLS, KC__VOLDOWN, KC__VOLUP, KC__MUTE
),
